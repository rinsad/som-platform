...
router.post('/',                   verifyToken, requirePermission('purchase-requests', 'can_create'), prController.createUploadMiddleware, prController.create);
router.get('/:id',                 verifyToken, requirePermission('purchase-requests'), prController.getById);
router.patch('/:id',               verifyToken, requirePermission('purchase-requests', 'can_edit'), prController.createUploadMiddleware, prController.updateDraft);
...
router.patch('/:id/supplier-selection', verifyToken, requirePermission('purchase-requests', 'can_edit'), prController.selectSupplierQuotation);
